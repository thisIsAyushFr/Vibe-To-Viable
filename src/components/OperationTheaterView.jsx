...
const SURGERY_STAGES = ['Preparation', 'Anesthesia', 'Procedure', 'Closure', 'Recovery'];

const SURGERY_DETAILS = {
  'ot-1': {
    diagnosis: 'Triple Vessel Coronary Artery Disease',
    estimatedDuration: '4 hours',
    anesthetist: 'Dr. Neha Kapoor (Cardiac Anesthesia)',
    nurses: 'Scrub Nurse: Ritu Menon • Circulating Nurse: Divya Pillai',
    equipment: 'Cath Lab Suite, Angioplasty Balloon Kit, Drug-Eluting Stents',
    bloodRequirement: '2 Units PRBC (Cross-matched & on standby)',
    consentStatus: 'Signed & Verified',
    currentStage: 'Procedure',
    stageProgress: 65,
    remainingTime: '1 hr 25 min'
  },
  'ot-2': {
    diagnosis: 'Severe Osteoarthritis — Right Knee',
    estimatedDuration: '3.5 hours',
    anesthetist: 'Dr. Rohan Desai (Regional Anesthesia)',
    nurses: 'Scrub Nurse: Kavita Reddy • Circulating Nurse: Sneha Iyer',
    equipment: 'Robotic Surgical Arm, Total Knee Implant Set',
    bloodRequirement: '1 Unit PRBC (On standby)',
    consentStatus: 'Signed & Verified',
    currentStage: 'Procedure',
    stageProgress: 40,
    remainingTime: '2 hr 10 min'
  },
  'ot-3': {
    diagnosis: 'Chronic Subdural Hematoma',
    estimatedDuration: '3 hours',
    anesthetist: 'Dr. Neha Kapoor (Neuro Anesthesia)',
    nurses: 'Scrub Nurse: Priya Menon • Circulating Nurse: Anjali Sharma',
    equipment: 'Neuro Navigation System, Craniotomy Instrument Set',
    bloodRequirement: '2 Units PRBC (Cross-matched)',
    consentStatus: 'Pending Family Signature',
    currentStage: 'Preparation',
    stageProgress: 10,
    remainingTime: 'Starts 02:30 PM'
  }
};
